...
- [Attention-based Models TSC/TSER](https://github.com/Navidfoumani/TSC_Survey/tree/main#attention-based-models)
- [Graph Neural Network Models TSC/TSER](https://github.com/Navidfoumani/TSC_Survey/tree/main#graph-neural-network)
- [Self_supervised Model](https://github.com/Navidfoumani/TSC_Survey/tree/main#self-supervised)
...
| TempCNN-LFMC | [Live fuel moisture content estimation from MODIS: A deep learning approach](https://www.sciencedirect.com/science/article/abs/pii/S0924271621001957) | ISPRS J. Photogramm. Remote Sens. |2021 | [code](https://github.com/lynn-miller/LFMC_from_MODIS)|
| Multi-tempCNN | [Multi-modal temporal CNNs for live fuel moisture content estimation](https://www.sciencedirect.com/science/article/abs/pii/S1364815222001712) | Environ. Model. Softw. |2022 | [code](https://github.com/lynn-miller/LFMC_estimation/tree/Multi_modal_LFMC)|
